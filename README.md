...
- ALL: printing keeps printer resolution instead of a low-DPI bitmap, so small map and image details stay readable; topic frames stay around the text when printing to PDF or PostScript
