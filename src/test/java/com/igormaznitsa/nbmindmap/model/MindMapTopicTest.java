...
public class MindMapTopicTest {
  ...
  public void testParse_OnlyTopic() throws Exception {
    ...
    final MindMapTopic topic = MindMapTopic.parse(mm,"# Topic");
  ...
  public void testParse_TopicAndChild() throws Exception {
    ...
    final MindMapTopic child = topic.getChildren().get(0);
  ...
  public void testParse_TopicAndTwoChildren() throws Exception {
    ...
    final MindMapTopic child1 = topic.getChildren().get(0);
    assertEquals("Child1", child1.getText());
    assertTrue(child1.getChildren().isEmpty());

    final MindMapTopic child2 = topic.getChildren().get(1);
  ...
  public void testParse_MultiLevels() throws Exception {
    final MindMap mm = new MindMap();
    final MindMapTopic root = MindMapTopic.parse(mm,"#Level1\n##Level2.1\n###Level3.1\n##Level2.2\n###Level3.2\n####Level4.2\n##Level2.3");
    ...
    final MindMapTopic level32 = root.getChildren().get(1).getChildren().get(0);
  ...
  public void testParse_WriteOneLevel() throws Exception {
    final MindMap mm = new MindMap();
    final MindMapTopic root = new MindMapTopic(mm,null,"Level1");
  ...
  public void testParse_WriteTwoLevel() throws Exception {
    final MindMap mm = new MindMap();
    final MindMapTopic root = new MindMapTopic(mm,null,"Level1");
    new MindMapTopic(mm,root, "Level2");
    final StringWriter writer = new StringWriter();
    root.write(writer);
    assertEquals("# Level1\n## Level2\n",writer.toString());
  }
  ...
  public void testParse_WriteThreeLevel() throws Exception {
    final MindMap mm = new MindMap();
    final MindMapTopic root = new MindMapTopic(mm,null,"Level1");
    final MindMapTopic level2 = new MindMapTopic(mm,root, "Level2");
    new MindMapTopic(mm,level2, "Level3");
    new MindMapTopic(mm,root, "Level2.1");
    final StringWriter writer = new StringWriter();
    root.write(writer);
    assertEquals("# Level1\n## Level2\n### Level3\n## Level2.1\n",writer.toString());
  }
