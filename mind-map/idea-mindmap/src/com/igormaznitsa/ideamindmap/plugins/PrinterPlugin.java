...
public class PrinterPlugin extends AbstractPopupMenuItemPlugin {
  ...
  @Nullable @Override public JMenuItem makeMenuItem(@Nonnull final MindMapPanel mindMapPanel, @Nonnull DialogProvider dialogProvider, @Nullable Topic topic,
    @Nullable @MustNotContainNull Topic[] topics, @Nullable MindMapPopUpItemCustomProcessor mindMapPopUpItemCustomProcessor) {
