...
public enum RenderQuality {
  ...
  static {
    ...
    RENDERING_HINTS_SPEED.put(RenderingHints.KEY_TEXT_ANTIALIASING,
        RenderingHints.VALUE_TEXT_ANTIALIAS_OFF);
    RENDERING_HINTS_SPEED.put(RenderingHints.KEY_INTERPOLATION,
        RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR);
    RENDERING_HINTS_SPEED.put(RenderingHints.KEY_ALPHA_INTERPOLATION,
        RenderingHints.VALUE_ALPHA_INTERPOLATION_SPEED);
    RENDERING_HINTS_SPEED.put(RenderingHints.KEY_COLOR_RENDERING,
