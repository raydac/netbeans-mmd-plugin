...
public class UnfoldAllPlugin extends AbstractPopupMenuItemPlugin {

  private static final ImageIcon ICO = ImageIconServiceProvider.findInstance().getIconForId(ImageIconID.POPUP_UNFOLDALL);
