...
public class ColorAttributePanelTest extends AbstractUiStarter {
  ...
  public JPanel makePanel(final UIComponentFactory componentFactory,
    ...
    final ColorAttributePanel panel = new ColorAttributePanel(componentFactory, dialogProvider, map, Color.RED, Color.YELLOW, null, null);
    return panel.getPanel();
  }

  public static void main(final String ... args) {
    AbstractUiStarter.main(ColorAttributePanelTest.class.getName());
  }
