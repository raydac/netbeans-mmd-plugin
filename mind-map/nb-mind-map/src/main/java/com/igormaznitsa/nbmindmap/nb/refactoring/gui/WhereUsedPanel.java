...
public final class WhereUsedPanel extends javax.swing.JPanel implements CustomRefactoringPanel {
  ...
  public WhereUsedPanel(final Lookup lookup, final String mindMapName, final boolean findInComments,
                        final ChangeListener parent) {
    initComponents();
    this.lookup = lookup;
  ...
  private void initComponents() {
    ...
    panelScope = new org.netbeans.modules.refactoring.spi.ui.ScopePanel(
        WhereUsedPanel.class.getCanonicalName().replace('.', '-'),
        NbPreferences.forModule(WhereUsedPanel.class), "whereUsed.scope");
    ...
    org.openide.awt.Mnemonics.setLocalizedText(labelTextFieldName,
        bundle.getString("WhereUsedPanel.labelTextFieldName.text")); // NOI18N

    org.openide.awt.Mnemonics.setLocalizedText(checkBoxFindInComments,
        bundle.getString("WhereUsedPanel.checkBoxFindInComments.text")); // NOI18N
    ...
    labelMindMapName.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/com/igormaznitsa/nbmindmap/icons/logo/logo16.png"))); // NOI18N
    org.openide.awt.Mnemonics.setLocalizedText(labelMindMapName,
        bundle.getString("WhereUsedPanel.labelMindMapName.text")); // NOI18N

    org.openide.awt.Mnemonics.setLocalizedText(labelScopeName,
        bundle.getString("WhereUsedPanel.labelScopeName.text")); // NOI18N
  ...
  private void checkBoxFindInCommentsActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBoxFindInCommentsActionPerformed
