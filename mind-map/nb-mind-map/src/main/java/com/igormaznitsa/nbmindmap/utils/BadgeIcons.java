...
public final class BadgeIcons {
  private static final Image BADGE_ICON_10 =
      ImageUtilities.loadImage("com/igormaznitsa/nbmindmap/icons/logo/badge.png");
  private static final Image BADGE_ICON_16 =
      ImageUtilities.loadImage("com/igormaznitsa/nbmindmap/icons/logo/logo16.png");
  private static final @StaticResource String ICON_PATH =
      "com/igormaznitsa/nbmindmap/icons/folder16.gif"; // NOI18N
  private static final @StaticResource String OPENED_ICON_PATH =
      "com/igormaznitsa/nbmindmap/icons/folderOpen16.gif"; // NOI18N
  ...
  private static Image makeBadgedImage(@Nonnull final Image original) {
    ...
    try {
      ...
      gfx.drawImage(badge, result.getWidth() - badge.getWidth(null),
          result.getHeight() - badge.getHeight(null), null);
    } finally {
      gfx.dispose();
    }
    return result;
  ...
  public static Image getTreeFolderIcon(boolean opened) {
    Image base = (Image) UIManager.get(
        opened ? OPENED_ICON_KEY_UIMANAGER_NB : ICON_KEY_UIMANAGER_NB); // #70263;
    if (base == null) {
      Icon baseIcon =
