...
public final class FindTextPanel extends javax.swing.JPanel implements FindTextScopeProvider {
  ...
  private void initComponents() {
    ...
    buttonPrev.setIcon(new javax.swing.ImageIcon(getClass().getResource(
        "/com/igormaznitsa/nbmindmap/icons/find/resultset_previous.png"))); // NOI18N
    ...
    buttonNext.setIcon(new javax.swing.ImageIcon(getClass().getResource(
        "/com/igormaznitsa/nbmindmap/icons/find/resultset_next.png"))); // NOI18N
    ...
    labelClose.setIcon(new javax.swing.ImageIcon(getClass().getResource(
        "/com/igormaznitsa/nbmindmap/icons/find/nimbusCloseFrame.png"))); // NOI18N
    ...
    toggleButtonCaseSensitive.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/com/igormaznitsa/nbmindmap/icons/find/case16.png"))); // NOI18N
    ...
    toggleButtonTopicText.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/com/igormaznitsa/nbmindmap/icons/find/text16.png"))); // NOI18N
    ...
    toggleButtonNote.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/com/igormaznitsa/nbmindmap/icons/find/note16.png"))); // NOI18N
    ...
    toggleButtonFile.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/com/igormaznitsa/nbmindmap/icons/find/disk16.png"))); // NOI18N
    ...
    toggleButtonURI.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/com/igormaznitsa/nbmindmap/icons/find/url16.png"))); // NOI18N
  ...
  private void findNext() {
    ...
    if (!text.isEmpty()) {
      this.baseEditor.findNext(string2pattern(text,
  ...
  private void findPrev() {
    final String text = this.textFieldSearchText.getText();
    if (!text.isEmpty()) {
      this.baseEditor.findPrev(string2pattern(text,
          this.toggleButtonCaseSensitive.isSelected() ? Pattern.UNICODE_CASE :
