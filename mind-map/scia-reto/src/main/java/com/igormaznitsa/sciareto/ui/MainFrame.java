...
public final class MainFrame extends javax.swing.JFrame implements Context, PlatformMenuAction,
  ...
  private static final String FILE_NAME_UNSAVED_DOC_CONTAINER = ".sr_unsaved_docs.$$$";
  ...
  public MainFrame(@Nullable final GraphicsConfiguration gfc,
                   @Nonnull @MustNotContainNull final String... args) throws IOException {
    super(gfc);
    registerApplicationFonts();
    initComponents();

    if (PlatformProvider.getPlatform()
        .registerPlatformMenuEvent(com.igormaznitsa.sciareto.ui.platform.PlatformMenuEvent.ABOUT,
            this)) {
      this.menuHelp.setVisible(false);
    }

    if (PlatformProvider.getPlatform().registerPlatformMenuEvent(
        com.igormaznitsa.sciareto.ui.platform.PlatformMenuEvent.PREFERENCES, this)) {
      this.menuPreferences.setVisible(false);
    }

    if (PlatformProvider.getPlatform()
        .registerPlatformMenuEvent(com.igormaznitsa.sciareto.ui.platform.PlatformMenuEvent.QUIT,
            this)) {
    ...
    this.explorerTree = new ExplorerTree(node -> this.mindMapPanelConfig.getOptionalProperty(
        AdditionalPreferences.PROPERTY_SHOW_HIDDEN_FILES, true), this);
    ...
    if (SystemUtils.isMac()) {
      this.menuOpenProject.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
      this.menuOpenFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask())); // ?

      this.menuSave.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
      this.menuSaveAll.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() | KeyEvent.SHIFT_MASK));

      this.menuExit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));

      this.menuGoToFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
      this.menuRedo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() | KeyEvent.SHIFT_MASK));
      this.menuUndo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
      this.menuFindText.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
      ...
      this.menuEditShowTreeContextMenu.setAccelerator(
          KeyStroke.getKeyStroke(KeyEvent.VK_Q, KeyEvent.CTRL_MASK | KeyEvent.SHIFT_MASK));
      this.menuFullScreen.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() | KeyEvent.CTRL_MASK));

      this.menuEditSelectAll.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
      this.menuEditSelectNone.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,
          KeyEvent.SHIFT_MASK | Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
    } else {

      this.menuOpenProject.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() | KeyEvent.SHIFT_MASK));
      this.menuOpenFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
      this.menuSave.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
      ...
      this.menuGoToFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() | KeyEvent.SHIFT_MASK));
      this.menuRedo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() | KeyEvent.SHIFT_MASK));
      this.menuUndo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z,
      ...
      this.menuEditShowTreeContextMenu.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T,
          Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() | KeyEvent.SHIFT_MASK));
      this.menuFullScreen.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F11, 0));

      this.menuEditSelectAll.setAccelerator(
          KeyStroke.getKeyStroke(KeyEvent.VK_A, KeyEvent.CTRL_MASK));
      this.menuEditSelectNone.setAccelerator(
          KeyStroke.getKeyStroke(KeyEvent.VK_A, KeyEvent.SHIFT_MASK | KeyEvent.CTRL_MASK));
    }
  ...
  public static void showExceptionDialog(@Nonnull final Exception ex) {
    ...
    Utils.safeSwingBlockingCall(() -> {
      DialogProviderManager.getInstance().getDialogProvider().msgError(
          ...
          String.format(
              SrI18n.getInstance().findBundle().getString("mainFrame.showExceptionDialog.msg"),
              ex.getMessage()));
    });
  }
  ...
  private void fillLanguageMenu() {
    final LocalizationController.Language selected =
        LocalizationController.getInstance().getLanguage();
          ...
          langMenuItem.addItemListener(x -> {
            if (x.getStateChange() == ItemEvent.SELECTED) {
              ...
              DialogProviderManager.getInstance().getDialogProvider()
                  .msgWarn(this, SrI18n.getInstance().findBundle()
                      .getString("mainFrame.languageChange.notification"));
            }
          });
  ...
  private void fillScaleUiMenu() {
    ...
    Stream.of("None", "1", "1.5", "2", "2.5", "3", "3.5", "4", "4.5", "5")
        .forEach(scale -> {
          ...
          final JRadioButtonMenuItem scaleMenuItem =
              new JRadioButtonMenuItem(none ? scale : "x" + scale, selected);
  ...
  private boolean isTryKeepNonSavedDocs() {
    return this.mindMapPanelConfig.getOptionalProperty(PROPERTY_TRY_KEEP_NON_SAVED_DOCS, false);
  }
  ...
  private void updateMenuItemsForProvider(@Nullable final TabProvider provider) {
    if (provider == null) {
      ...
      this.menuEditSelectNone.setEnabled(
          provider.isSelectCommandAllowed(SelectCommand.SELECT_NONE));
      ...
      if (importers.isEmpty()) {
        ...
        importers.stream().sorted((a, b) -> a.getTitle().compareTo(b.getTitle()))
            .forEach(importer -> {
      ...
      if (exporters.isEmpty()) {
        ...
        exporters.stream().sorted((a, b) -> a.getTitle().compareTo(b.getTitle()))
            .forEach(exporter -> {
  ...
  public void processTabChanged(@Nullable final TabTitle title) {
    ...
    if (title != null && !this.tabPane.isEmpty() &&
        title.getProvider().doesSupportPatternSearch()) {
  ...
  @Override
  public boolean doPlatformMenuAction(@Nonnull final PlatformMenuEvent event,
  ...
  private boolean doClosing() {
    ...
    if (!hasUnsaved && !unsavedFileItems.isEmpty()) {
      try {
        MultiFileContainer.getInstance().write(FILE_NAME_UNSAVED_DOC_CONTAINER, unsavedFileItems)
            .ifPresent(file -> {
              LOGGER.info(
                  "Saved container of unsaved docs " + unsavedFileItems.size() + ": " + file);
            });
      } catch (Exception ex) {
        LOGGER.error("Can't save unsaved doc as file for error", ex);
        hasUnsaved = true;
      }
    }
  ...
  @Override
  public void notifyFileRenamed(@Nullable @MustNotContainNull final List<File> affectedFiles,
                                @Nonnull final File oldFile, @Nonnull final File newFile) {
  ...
  private void restoreState() {
    ...
    try {
      final MultiFileContainer container = MultiFileContainer.getInstance();
      if (container.isFileExists(FILE_NAME_UNSAVED_DOC_CONTAINER)) {
        restoredUnsavedDocs = container.read(FILE_NAME_UNSAVED_DOC_CONTAINER);
        LOGGER.info("Detected unsaved docs: " + restoredUnsavedDocs.size());
        container.deleteFile(FILE_NAME_UNSAVED_DOC_CONTAINER);
        LOGGER.info("Removed unsaved docs container");
      } else {
        LOGGER.info("There is no unsaved doc container");
      }
    } catch (Exception ex) {
      LOGGER.error("Can't restore unsaved doc container", ex);
    }
    ...
    try {
      ...
      for (final MultiFileContainer.FileItem item : restoredUnsavedDocs) {
        final File file = item.getFile();
        if (file != null) {
          this.tabPane.findForFile(file).ifPresentOrElse(
              t -> {
                ...
                LOGGER.warn("Can't find title to restore state for file: " + file);
              });
        }
      }
      ...
      for (int i = 0; i < this.tabPane.getTabCount(); i++) {
        ...
        if (tab.getType() == EditorContentType.PLANTUML ||
            tab.getType() == EditorContentType.KSTPL) {
          SwingUtilities.invokeLater(() -> {
      ...
      if (this.tabPane.focusToFile(file, line)) {
        ...
        if (ext.equals("mmd")) { //NOI18N
          ...
          try {
            ...
            SourceTextEditor.SUPPORTED_EXTENSIONS.contains("*" + nameInLowerCase)) {
          try {
          ...
          if (SystemFileExtensionManager.getInstance()
              .isSystemFileExtension(FilenameUtils.getExtension(file.getName()))) {
            LOGGER.info("Exension of file " + file.getName() +
                " among extensions to be opened in system browser");
            result = false;
          } else {
  ...
  private void processTabChange() {
    this.menuFindText.setEnabled(!this.tabPane.isEmpty() &&
        this.tabPane.getCurrentTitle().getProvider().doesSupportPatternSearch());

    if (this.tabPane.isEmpty() ||
        !this.tabPane.getCurrentTitle().getProvider().doesSupportPatternSearch()) {
      hideFindTextPane();
    }
  ...
  public void showFindTextPane(@Nullable final String text) {
    ...
    if (current != null &&
      ...
      final boolean mmdEditor =
          current.getProvider().getEditor().getEditorContentType() == EditorContentType.MINDMAP;
  ...
  public boolean deleteTreeNode(@Nonnull final NodeFileOrFolder node) {
    ...
    if (file != null && file.exists()) {
      ...
      if (hasUnsaved &&
          !DialogProviderManager.getInstance().getDialogProvider().msgConfirmOkCancel(this,
              SrI18n.getInstance().findBundle()
                  .getString("mainFrame.deleteTreeNode.confirmDelete.title"),
              SrI18n.getInstance().findBundle()
                  .getString("mainFrame.deleteTreeNode.confirmDelete.msg"))) {
        return false;
      }
      ...
      List<File> affectedFiles =
          project == null ? Collections.EMPTY_LIST : project.findAffectedFiles(file);
      ...
      if (file.isDirectory()) {
        if (SystemUtils.deleteFile(file, DELETE_MOVING_FILE_TO_TRASH)) {
          ...
          DialogProviderManager.getInstance().getDialogProvider().msgError(this,
              SrI18n.getInstance().findBundle()
                  .getString("mainFrame.deleteTreeNode.cantDeleteDir"));
        }
      } else {
        ...
        if (!ok) {
          DialogProviderManager.getInstance().getDialogProvider().msgError(this,
              SrI18n.getInstance().findBundle()
                  .getString("mainFrame.deleteTreeNode.cantDeleteFile"));
        }
      }
  ...
  private void initComponents() {
    ...
    menuFile.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile")); // NOI18N
    ...
    menuNewProject.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/box_closed.png"))); // NOI18N
    menuNewProject.setMnemonic('w');
    menuNewProject.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemNewProject")); // NOI18N
    ...
    menuNewFile.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/document16.png"))); // NOI18N
    menuNewFile.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemNewFile")); // NOI18N
    ...
    menuOpenProject.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/open_folder.png"))); // NOI18N
    menuOpenProject.setMnemonic('e');
    menuOpenProject.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemOpenProject")); // NOI18N
    ...
    menuOpenRecentProject.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemOpenRecentProject")); // NOI18N
    menuFile.add(menuOpenRecentProject);

    menuOpenFile.setMnemonic('o');
    menuOpenFile.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemOpenFile")); // NOI18N
    ...
    menuSave.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/diskette.png"))); // NOI18N
    menuSave.setMnemonic('s');
    menuSave.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemSave")); // NOI18N
    ...
    menuSaveAs.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/menu_icons/file_save_as.png"))); // NOI18N
    menuSaveAs.setMnemonic('v');
    menuSaveAs.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemSaveAs")); // NOI18N
    ...
    menuSaveAll.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/menu_icons/disk_multiple.png"))); // NOI18N
    menuSaveAll.setMnemonic('a');
    menuSaveAll.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemSaveAll")); // NOI18N
    ...
    menuOpenRecentFile.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemOpenRecentFile")); // NOI18N
    menuFile.add(menuOpenRecentFile);
    menuFile.add(jSeparator9);

    menuFileExportAs.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemExportAs")); // NOI18N
    menuFile.add(menuFileExportAs);

    menuFileImportFrom.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemImportFrom")); // NOI18N
    menuFile.add(menuFileImportFrom);
    menuFile.add(separatorExitSection);

    menuExit.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/door_in.png"))); // NOI18N
    menuExit.setMnemonic('x');
    menuExit.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemFile.itemExit")); // NOI18N
    ...
    menuEdit.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit")); // NOI18N
    ...
    menuEditShowTreeContextMenu.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/tree_list16.png"))); // NOI18N
    menuEditShowTreeContextMenu.setMnemonic('t');
    menuEditShowTreeContextMenu.setText(
        com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
            .getString("mainMenu.itemEdit.itemShowTreeContextMenu")); // NOI18N
    ...
    menuUndo.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/undo.png"))); // NOI18N
    menuUndo.setMnemonic('u');
    menuUndo.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemUndo")); // NOI18N
    ...
    menuRedo.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/redo.png"))); // NOI18N
    menuRedo.setMnemonic('r');
    menuRedo.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemRedo")); // NOI18N
    ...
    menuEditSelectAll.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/selectall16.png"))); // NOI18N
    menuEditSelectAll.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemSelectAll")); // NOI18N
    ...
    menuEditSelectNone.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/selectnone16.png"))); // NOI18N
    menuEditSelectNone.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemSelectNone")); // NOI18N
    ...
    menuEditCut.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/cut16.png"))); // NOI18N
    menuEditCut.setMnemonic('t');
    menuEditCut.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemCut")); // NOI18N
    ...
    menuEditCopy.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/page_copy16.png"))); // NOI18N
    menuEditCopy.setMnemonic('y');
    menuEditCopy.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemCopy")); // NOI18N
    ...
    menuEditPaste.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/paste_plain16.png"))); // NOI18N
    menuEditPaste.setMnemonic('p');
    menuEditPaste.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemPaste")); // NOI18N
    ...
    menuFindText.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/find16.png"))); // NOI18N
    menuFindText.setMnemonic('n');
    menuFindText.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemFindText")); // NOI18N
    ...
    menuPreferences.setIcon(new javax.swing.ImageIcon(
        getClass().getResource("/menu_icons/setting_tools.png"))); // NOI18N
    menuPreferences.setMnemonic('e');
    menuPreferences.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemEdit.itemPreferences")); // NOI18N
    ...
    menuView.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView")); // NOI18N
    ...
    menuLanguage.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/language16.png"))); // NOI18N
    menuLanguage.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainFrame.menuLanguage")); // NOI18N
    menuView.add(menuLanguage);

    menuViewUIScale.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/scale_image.png"))); // NOI18N
    menuViewUIScale.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView.itemUiScale")); // NOI18N
    menuView.add(menuViewUIScale);

    menuFullScreen.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/monitor.png"))); // NOI18N
    menuFullScreen.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView.itemFullScreen")); // NOI18N
    ...
    menuLookAndFeel.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/application.png"))); // NOI18N
    menuLookAndFeel.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView.itemLookAndFeel")); // NOI18N
    menuView.add(menuLookAndFeel);

    menuViewZoom.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/zoom.png"))); // NOI18N
    menuViewZoom.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView.itemZoom")); // NOI18N

    menuViewZoomIn.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/zoom_in.png"))); // NOI18N
    menuViewZoomIn.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView.itemZoom.itemIn")); // NOI18N
    ...
    menuViewZoomOut.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/zoom_out.png"))); // NOI18N
    menuViewZoomOut.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView.itemZoom.itemOut")); // NOI18N
    ...
    menuViewZoomReset.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/zoom_actual.png"))); // NOI18N
    menuViewZoomReset.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemView.itemZoom.itemReset")); // NOI18N
    ...
    menuNavigate.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemNavigate")); // NOI18N
    ...
    menuGoToFile.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/rocket.png"))); // NOI18N
    menuGoToFile.setMnemonic('f');
    menuGoToFile.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemNavigate.itemGoToFile")); // NOI18N
    ...
    menuNavigateLinksGraph.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/graph16.png"))); // NOI18N
    menuNavigateLinksGraph.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemNavigate.itemBuildFileLinksGraph")); // NOI18N
    ...
    menuHelp.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemHelp")); // NOI18N

    menuHelpHelp.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/help.png"))); // NOI18N
    menuHelpHelp.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemHelp.itemHelp")); // NOI18N
    ...
    menuHelpPLantUmpManual.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/factory.png"))); // NOI18N
    menuHelpPLantUmpManual.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemHelp.itemPlatUMLManual")); // NOI18N
    ...
    menuAbout.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/menu_icons/information.png"))); // NOI18N
    menuAbout.setMnemonic('a');
    menuAbout.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemHelp.itemAbout")); // NOI18N
    ...
    menuMakeDonation.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/coins_in_hand16.png"))); // NOI18N
    menuMakeDonation.setMnemonic('m');
    menuMakeDonation.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("mainMenu.itemHelp.itemMakeDonation")); // NOI18N
  ...
  private void menuAboutActionPerformed(
    ...
    JOptionPane.showMessageDialog(SciaRetoStarter.getApplicationFrame(), scrollPane,
        SrI18n.getInstance().findBundle().getString("mainFrame.menuAboutActionPerformed.title"),
        JOptionPane.PLAIN_MESSAGE);
  }//GEN-LAST:event_menuAboutActionPerformed

  private void menuOpenProjectActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuOpenProjectActionPerformed
      ...
      public Icon getIcon(final File f) {
        ...
        if (f.isDirectory()) {
          ...
          if (knowledge.isDirectory()) {
            if (KNOWLEDGE_FOLDER_ICO == null) {
              ...
              if (superIcon == null || superIcon instanceof ImageIcon) {
                superIcon =
                    superIcon == null ? UIManager.getIcon("FileView.directoryIcon") : superIcon;
                KNOWLEDGE_FOLDER_ICO = new ImageIcon(
                    UiUtils.makeBadgedRightBottom(UiUtils.iconToImage(fileChooser, superIcon),
          ...
          return result;
            ...
            f.getName().toLowerCase(Locale.ENGLISH).endsWith(".mmd")) { //NOI18N
    ...
    fileChooser.setDialogTitle(
        SrI18n.getInstance().findBundle().getString("mainFrame.openProjectFolder.title"));

    if (fileChooser.showOpenDialog(SciaRetoStarter.getApplicationFrame()) ==
  ...
  public NodeProject asyncReloadProject(@Nonnull final NodeProject project,
    ...
    project.initLoading(Mono.just(project)
        .map(proj -> {
          SwingUtilities.invokeLater(() -> ProjectLoadingIconAnimationController.getInstance()
              .registerLoadingProject(this.explorerTree.getProjectTree(), proj));
          return proj;
        })
        .flatMap(proj -> proj.readSubtree(this.mindMapPanelConfig.getOptionalProperty(
            AdditionalPreferences.PROPERTY_SHOW_HIDDEN_FILES, true)))
        .doOnError(error -> {
          LOGGER.error("Can't open project", error);
          SwingUtilities.invokeLater(() -> {
            DialogProviderManager.getInstance().getDialogProvider().msgError(this,
                String.format(
                    SrI18n.getInstance().findBundle().getString("mainFrame.msgCantOpenProject.msg"),
                    error.getMessage()));
          });
        })
        .doOnTerminate(() -> {
              ...
              () -> {
                SwingUtilities.invokeLater(() -> {
                  if (unfoldFirstProject) {
                    final NodeProject opened =
                        (NodeProject) this.explorerTree.getCurrentGroup().getChildAt(0);
  ...
  private void loadAndRefreshConfig() {
    try {
      ...
      SystemFileExtensionManager.getInstance().setExtensionsAsCommaSeparatedString(
          this.mindMapPanelConfig.getOptionalProperty(
              AdditionalPreferences.PROPERTY_EXTENSIONS_TO_BE_OPENED_IN_SYSTEM, null));
  ...
  public void editPreferences() {
    ...
    panel.doLayout();
    final Dimension panelSize = new Dimension(panel.getPreferredSize());
    panelSize.width += 64;
    panelSize.height += 64;

    final Rectangle rectangle = this.getGraphicsConfiguration().getBounds();
    panel.setPreferredSize(new Dimension(Math.min(panelSize.width, (rectangle.width * 3) / 4),
        Math.min(panelSize.height, (rectangle.height * 3) / 4)));
  ...
  private void menuSaveAllActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuSaveAllActionPerformed
    for (final TabTitle t : this.tabPane) {
      try {
        t.save();
      } catch (IOException ex) {
        ...
        DialogProviderManager.getInstance().getDialogProvider().msgError(this,
            SrI18n.getInstance().findBundle()
                .getString("mainFrame.menuSaveAllActionPerformed.error"));
      }
    }
  }//GEN-LAST:event_menuSaveAllActionPerformed

  private void menuPreferencesActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuPreferencesActionPerformed
    editPreferences();
  }//GEN-LAST:event_menuPreferencesActionPerformed

  private void menuOpenFileActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuOpenFileActionPerformed
    final File file = DialogProviderManager.getInstance()
        .getDialogProvider()
        .msgOpenFileDialog(null, null, "open-file",
            SrI18n.getInstance().findBundle()
                .getString("mainFrame.menuOpenFileActionPerformed.title"), null, true,
            new FileFilter[] {
  ...
  private void menuSaveActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuSaveActionPerformed
  ...
  private void menuSaveAsActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuSaveAsActionPerformed
    final int index = this.tabPane.getSelectedIndex();
    if (index >= 0) {
      try {
        ...
        DialogProviderManager.getInstance().getDialogProvider().msgError(this,
            SrI18n.getInstance().findBundle()
                .getString("mainFrame.menuSaveAsActionPerformed.error"));
      }
    }
  ...
  private void menuNewProjectActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuNewProjectActionPerformed
    final JFileChooser folderChooser = new JFileChooser();
    folderChooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
    folderChooser.setDialogTitle(SrI18n.getInstance().findBundle()
        .getString("mainFrame.menuNewProjectActionPerformed.title"));
    folderChooser.setDialogType(JFileChooser.SAVE_DIALOG);
    folderChooser.setApproveButtonText(SrI18n.getInstance().findBundle()
        .getString("mainFrame.menuNewProjectActionPerformed.approve"));
    folderChooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
    if (folderChooser.showSaveDialog(SciaRetoStarter.getApplicationFrame()) ==
        JFileChooser.APPROVE_OPTION) {
      ...
      if (file.isDirectory()) {
        ...
        if (files == null) {
          ...
          DialogProviderManager.getInstance().getDialogProvider().msgError(this,
              String.format(SrI18n.getInstance().findBundle()
                      .getString("mainFrame.dlgNewProjectActionPerformed.errorDuringFolderProcess"),
                  file));
          return;
        }
        if (files.length > 0) {
          DialogProviderManager.getInstance().getDialogProvider().msgError(this,
              String.format(SrI18n.getInstance().findBundle()
                      .getString("mainFrame.dlgNewProjectActionPerformed.errorAlreadyExistsNotEmpty"),
                  file.getName()));
        } else {
        ...
        LOGGER.error("Can't create folder : " + file); //NOI18N
        DialogProviderManager.getInstance().getDialogProvider()
            .msgError(this, "Can't create folder: " + file);
      }
    }
  }//GEN-LAST:event_menuNewProjectActionPerformed

  private void menuFullScreenActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuFullScreenActionPerformed
        ...
        if (device.isFullScreenSupported()) {
          if (device.getFullScreenWindow() == null) {
            final JLabel label = new JLabel(
                SrI18n.getInstance().findBundle().getString("mainFrame.labelOpenedInFullScreen"));
          ...
          DialogProviderManager.getInstance().getDialogProvider().msgWarn(this,
              SrI18n.getInstance().findBundle()
                  .getString("mainFrame.dlgDeviceDoesntSupportFullscreen.msg"));
        }
      } else {
  ...
  private void menuMakeDonationActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuMakeDonationActionPerformed
    new DonateButton().doClick();
  }//GEN-LAST:event_menuMakeDonationActionPerformed

  private void menuGoToFileActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuGoToFileActionPerformed
    final GoToFilePanel panel = new GoToFilePanel(this.explorerTree, JOptionPane.OK_OPTION);
    if (DialogProviderManager.getInstance().getDialogProvider().msgOkCancel(this,
        SrI18n.getInstance().findBundle().getString("mainFrame.dlgGoToFile.title"), panel)) {
  ...
  private void menuFindTextActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuFindTextActionPerformed
    showFindTextPane(""); //NOI18N
  }//GEN-LAST:event_menuFindTextActionPerformed

  private void menuEditMenuSelected(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuEditMenuSelected
    final TabTitle title = this.getFocusedTab();
  ...
  private void menuEditMenuCanceled(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuEditMenuCanceled
    enableAllMenuItems();
  }//GEN-LAST:event_menuEditMenuCanceled

  private void menuEditMenuDeselected(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuEditMenuDeselected
    enableAllMenuItems();
  }//GEN-LAST:event_menuEditMenuDeselected

  private void menuFileMenuSelected(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuFileMenuSelected
    final TabTitle title = this.getFocusedTab();
    updateMenuItemsForProvider(title == null ? null : title.getProvider());
  }//GEN-LAST:event_menuFileMenuSelected

  private void menuFileMenuCanceled(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuFileMenuCanceled
    enableAllMenuItems();
  }//GEN-LAST:event_menuFileMenuCanceled

  private void menuFileMenuDeselected(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuFileMenuDeselected
    enableAllMenuItems();
  }//GEN-LAST:event_menuFileMenuDeselected

  private void menuEditCopyActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditCopyActionPerformed
    final TabTitle title = this.getFocusedTab();
  ...
  private void menuEditPasteActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditPasteActionPerformed
    final TabTitle title = this.getFocusedTab();
    if (title != null && title.getProvider().doesSupportCutCopyPaste()) {
  ...
  private void menuEditCutActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditCutActionPerformed
    final TabTitle title = this.getFocusedTab();
    if (title != null && title.getProvider().doesSupportCutCopyPaste()) {
  ...
  @Override
  public boolean showGraphMindMapFileLinksDialog(@Nullable final File projectFolder,
                                                 @Nullable final File initialMindMapFile,
    ...
    if (projectFolder != null || initialMindMapFile != null) {
      ...
      final FileLinkGraphPanel graph =
          new FileLinkGraphPanel(projectFolderToUse, initialMindMapFile);

      JOptionPane.showMessageDialog(this, graph,
          SrI18n.getInstance().findBundle().getString("mainFrame.dlgGraphFileLinks.title"),
          JOptionPane.PLAIN_MESSAGE);
      ...
      if (openIfSelected && fileToOpen != null) {
        ...
        if (cantFind) {
          DialogProviderManager.getInstance().getDialogProvider().msgWarn(this,
              String.format(SrI18n.getInstance().findBundle()
                      .getString("mainFrame.dlgGraphFileLinks.cantOpenFileMsg"),
  ...
  private void menuNavigateLinksGraphActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuNavigateLinksGraphActionPerformed
  ...
  private void menuNavigateMenuSelected(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuNavigateMenuSelected
    final TabTitle title = getFocusedTab();
    this.menuNavigateLinksGraph.setEnabled(title != null &&
        title.getProvider().getEditor().getEditorContentType() == EditorContentType.MINDMAP);
  }//GEN-LAST:event_menuNavigateMenuSelected

  private void menuEditShowTreeContextMenuActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditShowTreeContextMenuActionPerformed
    this.explorerTree.showPopUpForSelectedItem();
  }//GEN-LAST:event_menuEditShowTreeContextMenuActionPerformed

  private void menuNewFileActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuNewFileActionPerformed
    ...
    fileChooser.setDialogTitle(
        SrI18n.getInstance().findBundle().getString("mainFrame.fileChooserNewFile.title"));
    ...
    final Filter filerMindMap =
        new Filter("mmd", SrI18n.getInstance().findBundle().getString("mainFrame.fileFilter.mmd"));
    final Filter filerText =
        new Filter("txt", SrI18n.getInstance().findBundle().getString("mainFrame.fileFilter.txt"));
    final Filter filerPuml = new Filter("puml",
        SrI18n.getInstance().findBundle().getString("mainFrame.fileFilter.puml"));
    final Filter filerKstpl = new Filter("kstpl",
        SrI18n.getInstance().findBundle().getString("mainFrame.fileFilter.kstpl"));
    final Filter filerDot =
        new Filter("gv", SrI18n.getInstance().findBundle().getString("mainFrame.fileFilter.gv"));
    ...
    if (fileChooser.showDialog(this,
        SrI18n.getInstance().findBundle().getString("mainFrame.fileChooserNewFile.approve")) ==
        JFileChooser.APPROVE_OPTION) {
      ...
      if (!selectedFile.getName().contains(".")) {
        selectedFile =
            new File(selectedFile.getParent(), selectedFile.getName() + choosenFilter.extension);
      }
  ...
  private void menuHelpPLantUmpManualActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuHelpPLantUmpManualActionPerformed
  ...
  private void menuHelpHelpActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuHelpHelpActionPerformed
    UiUtils.openLocalResourceInDesktop(String.format("help/SciaReto_manual_%s.pdf",
        LocalizationController.getInstance().getLanguage().getLocaleManual().getLanguage()));
  }//GEN-LAST:event_menuHelpHelpActionPerformed

  private void menuViewMenuSelected(
      javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_menuViewMenuSelected
  ...
  private void menuViewZoomInActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuViewZoomInActionPerformed
    final AbstractEditor editor = this.tabPane.getCurrentEditor();
  ...
  private void menuViewZoomOutActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuViewZoomOutActionPerformed
    final AbstractEditor editor = this.tabPane.getCurrentEditor();
    if (editor != null && editor.isZoomable()) {
      editor.doZoomOut();
    }
  ...
  private void menuViewZoomResetActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuViewZoomResetActionPerformed
    final AbstractEditor editor = this.tabPane.getCurrentEditor();
    if (editor != null && editor.isZoomable()) {
      editor.doZoomReset();
    }
  ...
  private void menuEditSelectAllActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditSelectAllActionPerformed
    final TabTitle title = this.getFocusedTab();
    if (title != null) {
  ...
  private void menuEditSelectNoneActionPerformed(
      java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEditSelectNoneActionPerformed
    final TabTitle title = this.getFocusedTab();
    if (title != null) {
  ...
  public File createMindMapFile(@Nullable final File folder) {
    ...
    chooser.setDialogTitle(
        SrI18n.getInstance().findBundle().getString("mainFrame.createMMFileChooser.title"));
    chooser.setFileFilter(MMDEditor.makeFileFilter());
    chooser.setMultiSelectionEnabled(false);
    chooser.setApproveButtonText(
        SrI18n.getInstance().findBundle().getString("mainFrame.createMMFileChooser.approve"));

    File result = null;

    if (chooser.showSaveDialog(SciaRetoStarter.getApplicationFrame()) ==
        JFileChooser.APPROVE_OPTION) {
      ...
      if (file.exists()) {
        DialogProviderManager.getInstance().getDialogProvider()
            .msgError(this,
                String.format(SrI18n.getInstance().findBundle()
                    .getString("mainFrame.msgFileAlreadyExists.msg"), file));
      } else {
        try {
          final MindMap mindMap = new MindMap(true);
          mindMap.putAttribute(StandardMmdAttributes.MMD_ATTRIBUTE_GENERATOR_ID,
              IDEBridgeFactory.findInstance()
                  .getIDEGeneratorId());
          ...
          DialogProviderManager.getInstance().getDialogProvider().msgError(this,
              String.format(SrI18n.getInstance().findBundle()
                  .getString("mainFrame.msgCantSaveMindMapFile.msg"), file.getName()));
        }
      }
    }
    return result;
