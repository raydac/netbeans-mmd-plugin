...
public class NoteEditor extends javax.swing.JPanel {
  ...
  private void buttonImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImportActionPerformed
    ...
    final File toOpen = DialogProviderManager.getInstance().getDialogProvider().msgOpenFileDialog("user-home-dir", UiUtils.BUNDLE.getString("PlainTextEditor.buttonLoadActionPerformed.title"), home, true, TEXT_FILE_FILTER, "Open"); //NOI18N
    if (toOpen != null) {
      try {
  ...
  private void buttonExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonExportActionPerformed
    final File home = new File(System.getProperty("user.home")); //NOI18N
    final File toSave = DialogProviderManager.getInstance().getDialogProvider().msgSaveFileDialog("user-home-dir", UiUtils.BUNDLE.getString("PlainTextEditor.buttonSaveActionPerformed.saveTitle"), home, true, TEXT_FILE_FILTER, "Save");
    if (toSave != null) {
      try {
