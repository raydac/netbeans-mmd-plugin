...
public final class AboutPanel extends javax.swing.JPanel implements JHtmlLabel.LinkListener {
  ...
  public AboutPanel() {
    ...
    this.thirdParts.add(
        new ThirdPartLicense("JetBrains Mono fonts", "https://github.com/JetBrains/JetBrainsMono",
            "OFL 1.1", "https://opensource.org/licenses/OFL-1.1"));
    this.thirdParts.add(
        new ThirdPartLicense("Hybrid Mono fonts", "https://github.com/ghazyami/hybrid-mono-fonts",
            "OFL 1.1", "https://opensource.org/licenses/OFL-1.1"));
    this.thirdParts.add(
        new ThirdPartLicense("FatCow Farm-Fresh Web Icons", "http://www.fatcow.com/free-icons",
            "CC BY 3.0", "https://creativecommons.org/licenses/by/3.0/"));
    this.thirdParts.add(new ThirdPartLicense("Java Universal Network/Graph Framework",
        "https://github.com/jrtom/jung", "BSD 3",
        "https://raw.githubusercontent.com/jrtom/jung/master/LICENSE"));
    this.thirdParts.add(
        new ThirdPartLicense("RSynaxTextArea", "https://github.com/bobbylight/RSyntaxTextArea",
            "modified BSD license",
            "https://raw.githubusercontent.com/bobbylight/RSyntaxTextArea/master/src/main/dist/RSyntaxTextArea.License.txt"));
    this.thirdParts.add(new ThirdPartLicense("FlatLaf", "https://github.com/JFormDesigner/FlatLaf",
        "Apache License, Version 2.0",
        "https://raw.githubusercontent.com/JFormDesigner/FlatLaf/main/LICENSE"));
    this.thirdParts.add(new ThirdPartLicense("PlantUML", "http://plantuml.com/", "GPL License",
        "https://www.gnu.org/copyleft/gpl.html"));
    this.thirdParts.add(
        new ThirdPartLicense("Apache Batik", "https://xmlgraphics.apache.org/batik/",
            "Apache License, Version 2.0", "https://xmlgraphics.apache.org/batik/license.html"));
    ...
    this.tableThirdPartLibraries.setModel(new TableModel() {
      ...
      public String getColumnName(final int columnIndex) {
        switch (columnIndex) {
          case 0:
            return SrI18n.getInstance().findBundle().getString("AboutPanel.grid.title.component");
          case 1:
            return SrI18n.getInstance().findBundle().getString("AboutPanel.grid.title.license");
          default:
            return "<unknown>";
        }
      }
      ...
      @Override
      public void setValueAt(@Nonnull final Object aValue, final int rowIndex,
  ...
  private void initComponents() {
    ...
    textLabel.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("AboutPanel.labelInfo.text")); // NOI18N
    textLabel.setVerticalTextPosition(javax.swing.SwingConstants.TOP);
    tabbedPaneContent.addTab(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("AboutPanel.textLabel.TabConstraints.tabTitle"), textLabel); // NOI18N
    ...
    tabbedPaneContent.addTab(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
            .getString("AboutPanel.scrollPanelThirdParts.TabConstraints.tabTitle"),
        scrollPanelThirdParts); // NOI18N

    panelDonate.setBorder(javax.swing.BorderFactory.createEmptyBorder(8, 8, 8, 8));
    panelDonate.setLayout(new java.awt.BorderLayout());

    textLabelDonation.setText(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("AboutPanel.textLabelDonation.text")); // NOI18N
    ...
    tabbedPaneContent.addTab(com.igormaznitsa.sciareto.ui.SrI18n.getInstance().findBundle()
        .getString("AboutPanel.panelDonate.TabConstraints.tabTitle"), panelDonate); // NOI18N
  ...
  private static class ThirdPartLicense {
    ...
    ThirdPartLicense(@Nonnull final String library, @Nonnull final String libraryUrl,
                     @Nonnull final String license, @Nonnull final String licenseUrl) {
