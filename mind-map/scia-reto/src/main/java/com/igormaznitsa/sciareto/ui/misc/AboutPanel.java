...
public final class AboutPanel extends javax.swing.JPanel implements JHtmlLabel.LinkListener {
  ...
  public AboutPanel() {
    ...
    this.thirdParts.add(new ThirdPartLicense("Eclipse ELK", "https://github.com/eclipse/elk", "Eclipse Public License v2.0", "https://github.com/eclipse/elk/blob/master/LICENSE.md"));
