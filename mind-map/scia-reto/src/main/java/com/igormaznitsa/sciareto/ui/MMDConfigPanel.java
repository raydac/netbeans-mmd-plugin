...
public final class MMDConfigPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    colorChooserConnectorColor = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    colorChooserCollapsatorBorder = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    colorChooserCollapsatorBackground = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    jLabel5 = new javax.swing.JLabel();
    spinnerCollapsatorSize = new javax.swing.JSpinner();
    jLabel6 = new javax.swing.JLabel();
    spinnerCollapsatorWidth = new javax.swing.JSpinner();
    colorChooserJumpLink = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    jLabel7 = new javax.swing.JLabel();
    spinnerJumpLinkWidth = new javax.swing.JSpinner();
    jPanel4 = new javax.swing.JPanel();
    colorChooserPaperColor = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    checkBoxShowGrid = new javax.swing.JCheckBox();
    colorChooserGridColor = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    spinnerGridStep = new javax.swing.JSpinner();
    jLabel1 = new javax.swing.JLabel();
    jPanel2 = new javax.swing.JPanel();
    checkBoxDropShadow = new javax.swing.JCheckBox();
    colorChooserRootBackground = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    colorChooserRootText = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    colorChooser1stBackground = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    colorChooser1stText = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    colorChooser2ndBackground = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    colorChooser2ndText = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    ...
    colorChooserSelectLine = new com.igormaznitsa.sciareto.ui.ColorChooserButton();
    ...
    donateButton1 = new com.igormaznitsa.sciareto.ui.DonateButton();
  ...
  public void load() {
    ...
    try {
      ...
      this.checkboxUseInsideBrowser.setSelected(PreferencesManager.getInstance().getPreferences().getBoolean("useInsideBrowser", false));
      this.checkboxRelativePathsForFilesInTheProject.setSelected(PreferencesManager.getInstance().getPreferences().getBoolean("makeRelativePathToProject", true));
      this.checkBoxUnfoldCollapsedTarget.setSelected(PreferencesManager.getInstance().getPreferences().getBoolean("unfoldCollapsedTarget", true));
      this.checkBoxCopyColorInfoToNewAllowed.setSelected(PreferencesManager.getInstance().getPreferences().getBoolean("copyColorInfoToNewChildAllowed", true));
      this.checkBoxKnowledgeFolderAutogenerationAllowed.setSelected(PreferencesManager.getInstance().getPreferences().getBoolean(PREFERENCE_KEY_KNOWLEDGEFOLDER_ALLOWED, true));
  ...
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooser1stBackground;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooser1stText;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooser2ndBackground;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooser2ndText;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserCollapsatorBackground;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserCollapsatorBorder;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserConnectorColor;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserGridColor;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserJumpLink;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserPaperColor;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserRootBackground;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserRootText;
  private com.igormaznitsa.sciareto.ui.ColorChooserButton colorChooserSelectLine;
  private com.igormaznitsa.sciareto.ui.DonateButton donateButton1;
