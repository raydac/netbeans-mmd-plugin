...
public final class DonateButton extends JButton {
  ...
  private static final URI LINK = URI.create(
      "https://www.arthursacresanimalsanctuary.org/donate"); //NOI18N
    ...
    try {
      ...
      DialogProviderManager.getInstance().getDialogProvider()
          .msgError(SciaRetoStarter.getApplicationFrame(),
              SrI18n.getInstance().findBundle().getString("DonateButton.error") +
                  LINK.toASCIIString());
    }
  };
