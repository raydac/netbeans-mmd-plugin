...
public class SciaRetoStarter {
  ...
  public static final Version IDE_VERSION = new Version("sciareto", new long[] {1L, 6L, 10L}, null);
  ...
  private static final class LocalMMDExporter extends AbstractExporter {
    ...
    @Override
    public void doExportToClipboard(@Nonnull PluginContext context,
                                    @Nullable Set<AbstractParameter<?>> options,
                                    @Nonnull ExtrasToStringConverter stringConverter)
        throws IOException {
      final MindMap map = context.getModel();
