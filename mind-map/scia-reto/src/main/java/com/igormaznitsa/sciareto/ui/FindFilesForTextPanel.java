...
public final class FindFilesForTextPanel extends javax.swing.JPanel {
    ...
    private void startSearchThread(@Nonnull @MustNotContainNull final List<NodeFileOrFolder> scope, @Nullable final Pattern searchPatternForMmd, @Nonnull final byte[] dataToFindVariant1, @Nonnull final byte[] dataToFindVariant2) {
        int size = 0;
        ...
        final Runnable runnable = new Runnable() {
            ...
            private void processFile(final NodeFileOrFolder file) {
                ...
                if (searchPatternForMmd != null && f.isFile() && f.length() > 0L && "mmd".equalsIgnoreCase(FilenameUtils.getExtension(f.getName()))) {
                    MindMap mindMap;
  ...
  private void buttonFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFindActionPerformed
      ...
      try {
          ...
          startSearchThread(folders, pattern, str1, str2);
